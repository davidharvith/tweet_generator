...
/**
 * function creates a Markov Node and sets its data
 * to input data. if allocation fails it clears all data
 * @param data string litteral to store in markove node
 * @param p_markov_chain pointer to pointer to
 * @return pointer to new MarkovNode
 */
